...
from book.repositories.author_repository import AuthorAbstractRepository, AuthorRepository
...
from book.repositories.publisher_repository import PublisherAbstractRepository, PublisherRepository

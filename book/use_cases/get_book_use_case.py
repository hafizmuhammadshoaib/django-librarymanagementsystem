...
class GetBookUseCase:
    ...
    def get_book_by_id(self, book_id: str) -> Optional[Dict[str, Any]]:
        ...
        return self._enrich_book_data(book_entity)
    ...
    def get_all_books(self, include_details: bool = True) -> List[Dict[str, Any]]:
        ...
        """
        book_entities = self.book_repository.get_all_books()

        if include_details:
            return [self._enrich_book_data(book) for book in book_entities]
        else:
            return [book.to_dict() for book in book_entities]
    ...
    def get_books_by_genre(self, genre_id: str) -> List[Dict[str, Any]]:
        ...
        all_books = self.book_repository.get_all_books()
        genre_books = [book for book in all_books if genre_uuid in book.genre_ids]
    ...
    def _enrich_book_data(self, book_entity: BookEntity) -> Dict[str, Any]:
        ...
        # Add genre details
        genres = []
        for genre_id in book_entity.genre_ids:
